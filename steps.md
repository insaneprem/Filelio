# Filelio - Step by Step Guide

This guide will walk you through recreating the Filelio project, a file storage application built with Next.js, Clerk, Neon PostgreSQL, Drizzle ORM, and HeroUI.
...
```bash
npx create-next-app@latest filelio
cd filelio
```
...
```typescript
/**
 * Database Schema for Filelio
 *
 * This file defines the database structure for our Filelio application.
 ...
 * Files Table
 *
 * This table stores all files and folders in our Filelio.
    ...
    <SSRProvider>
      ...
      >
        ...
        >
          <ToastProvider>
            <VisuallyHidden>
              <h1>Filelio - Simple File Storage</h1>
            </VisuallyHidden>
            {children}
          </ToastProvider>
        </ThemeProvider>
...
export const metadata: Metadata = {
  title: "Filelio - Simple File Storage",
